...
## Next Execution Plan
1. Expand auth UX (password reset/email verification states).
2. Continue accessibility hardening (focus trapping and screen-reader walkthrough audits).
3. Expand routed-flow tests to cover dashboard/course/lesson transitions.
4. Add jsdom-backed component tests once dependency policy allows installation.
5. Deepen live data coverage for profile/settings pages.
