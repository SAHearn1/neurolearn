...
3. Add auth account-management flows (change password/session management).
4. Continue accessibility hardening with screen-reader walkthrough audits.
5. Persist settings/profile updates back to Supabase.
